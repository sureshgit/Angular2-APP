...
(function (window, angular) {
    ...
    'use strict';
    angular.module('mwl.calendar').directive('mwlCalendar', ["$rootScope", function ($rootScope) {
        return {
            templateUrl: 'src/calendarMonthEventsList',
            restrict: 'EA',
            scope: {
                events: '=',
                view: '=',
    ...
    'use strict';
    angular.module('mwl.calendar').directive('mwlCalendarYear', ["$rootScope", function ($rootScope) {
        return {
            templateUrl: 'src/calendarYearView',
            restrict: 'EA',
            require: '^mwlCalendar',
            scope: {
                events: '=',
    ...
    angular.module('mwl.calendar').directive('mwlCalendarWeek', function () {
        return {
            templateUrl: 'src/calendarWeekView',
            restrict: 'EA',
            require: '^mwlCalendar',
            scope: {
                events: '=',
    ...
    angular.module('mwl.calendar').directive('mwlCalendarSlideBox', function () {
        return {
            restrict: 'EA',
            templateUrl: 'src/calendarSlideBox',
            replace: true,
            controller: [
                '$scope',
                '$sce',
    ...
    angular.module('mwl.calendar').directive('mwlCalendarMonth', function () {
        return {
            templateUrl: 'src/calendarMonthView',
            restrict: 'EA',
            require: '^mwlCalendar',
            scope: {
                events: '=',
    ...
    angular.module('mwl.calendar').directive('mwlCalendarDay', function () {
        return {
            templateUrl: 'src/calendarDayView',
            restrict: 'EA',
            require: '^mwlCalendar',
            scope: {
                events: '=',
