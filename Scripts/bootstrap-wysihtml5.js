    ...
    var templates = {
        "font-styles": "<li class='dropdown'>" +
                           "<a class='btn dropdown-toggle' data-toggle='dropdown' >" +
                               "<i class='glyphicon glyphicon-font'></i>&nbsp;<span class='current-font'></span>&nbsp;<b class='caret'></b>" +
                           "</a>" +
        ...
        "emphasis":    "<li>" +
                           "<div class='btn-group'>" +
                               "<a class='btn moon-icon-bold' data-wysihtml5-command='bold' title='CTRL+B'></a>" +
                               "<a class='btn moon-icon-italic2' data-wysihtml5-command='italic' title='CTRL+I'></a>" +
                               "<a class='btn moon-icon-underline2' data-wysihtml5-command='underline' title='CTRL+U'></a>" +
                           "</div>" +
                       "</li>",
        "lists":       "<li>" +
                           "<div class='btn-group'>" +
        ...
        "link":        "<li>" +
                           "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade'>" +
                               ...
                               "<div class='modal-footer'>" +
                                   ...
                                   "<a  class='btn btn-primary2' data-dismiss='modal'>Insert link</a>" +
                               "</div>" +
                           "</div>" +
